...
- `@AyanoYukimura_FrozenCyan` (Cyan / Koto)
- `@AyanoYukimura_TwilightEmpress` (Purple / Biwa)
- `@AyanoYukimura_BloodIce` (Red / Shamisen)
- `@AyanoYukimura_PlatinumBride` (Silver / Shakuhachi)
- **Stage**: `@幽雅殿`
...
| No | Start | Dur | Lyric / Audio Event | Base ID | Shot Concept & Vidu Q2 Prompt |
|:---|:---|:---|:---|:---|:---|
| **04** | 0:22 | 5.5s | 白き肌に触れる風は<br>凍てつく記憶 呼び覚ます | *CYAN_V1* | **Walk / Cyan**. Start Walk. <br>`@AyanoYukimura_FrozenCyan が @幽雅殿 のランウェイをゆっくりと歩き出す。正面からのフルショット。冷たい霧を切り裂くように進む5.5秒間の継続的なキャットウォーク。` |
| **05** | 0:28 | 6.5s | Runway lights, cutting through the snow<br>誰も触れられない Cold as ice | *CYAN_V1* | **Walk / Cyan**. Lights & Snow. <br>`@AyanoYukimura_FrozenCyan が @幽雅殿 のランウェイを歩いている。スポットライトが彼女を照らし、背後でダイヤモンドのように輝く雪が舞い散る6.5秒間のシネマティックなワンカット。` |
| **06** | 0:34.5 | 6s | 近づけば壊れてしまう<br>Unreachable, untouchable, beautiful lie | *CYAN_V1* | **Walk / Cyan**. Gaze & Focus. <br>`@AyanoYukimura_FrozenCyan が @幽雅殿 のランウェイを前進しながら、カメラを射抜くような強い視線を送る。被写界深度が変化し、背景がボケて表情が浮かび上がる6秒間の継続ショット。` |
| **07** | 0:41 | 6.5s | 吐息さえも結晶に変わる<br>Now watch me freeze the time | *CYAN_V2* | **FX / Cyan**. Breath Detail. <br>`@AyanoYukimura_FrozenCyan の超クローズアップ。白い吐息が空中で瞬時に氷の結晶へと変わるディテールを描く。衣装から蒼い光の粒子が湧き上がる6.5秒間のワンショット。` |
...
| No | Start | Dur | Lyric / Audio Event | Base ID | Shot Concept & Vidu Q2 Prompt |
|:---|:---|:---|:---|:---|:---|
| **11** | 1:06 | 4s | (Interlude: Dark Turn) | *RED_V1* | **Action / Red**. Shamisen Attack. <br>`急激に暗転し、紅いライティングへ。@AyanoYukimura_BloodIce が三味線(Shamisen)を構え、激しくバチを叩きつける4秒間の攻撃的な演奏クローズアップ。` |
| **12** | 1:10 | 5s | DON'T TOUCH.<br>(Yuki-onna, freeze...) | *RED_V1* | **Action / Red**. Shamisen Hit. <br>`@AyanoYukimura_BloodIce が三味線(Shamisen)を力強く掻き鳴らし、カメラを睨む。@幽雅殿 が紅く染まり、彼女を包む真紅のファーが激しく揺れる5秒間の攻撃的なショット。` |
| **13** | 1:15 | 4s | Don't touch. | *RED_V2* | **Action / Red**. Smirk. <br>`@AyanoYukimura_BloodIce が不敵に微笑むクローズアップ。赤いゴシックメイクが際立ち、ファーコートを大きく翻して歩みを止める4秒間の継続的な表情ショット。` |
| **14** | 1:19 | 7s | (Interlude: Blizzard) | *RED_V1* | **Action / Red**. Shamisen Solo. <br>`@AyanoYukimura_BloodIce が猛吹雪の @幽雅殿 で乱れ狂うように三味線(Shamisen)を弾きまくる。シルバーチェーンと赤いファーが激しく揺れる、7秒間のエネルギッシュな演奏シーン。` |
